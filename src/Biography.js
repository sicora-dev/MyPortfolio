...
function Biography() {
    ...
    return (
        <div className='flex flex-grow flex-col lg:flex-row bg-[rgba(13,17,23,0.5)] p-5 rounded-[0.375rem] gap-4 about items-center h-full'>
            <img src='./foto_carnet.jpg' alt='Foto de Carnet' className=' h-auto w-52 sm:w-96 object-cover rounded-[0.375rem] xl:w-100 transition-transform transform hover:scale-105' />
